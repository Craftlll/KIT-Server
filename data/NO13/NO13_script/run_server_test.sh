...
# ==============================================================================
# Script Name: run_server_test.sh (NO13 Version)
# ==============================================================================

SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"
cd "$SCRIPT_DIR"

SERVICE_SCRIPT="NO13_lite_plumber.R"
PORT=8013
GENE_TO_TEST="GIT2"

echo "=========================================================="
echo "          Lite Service Deployment Verification (NO13)"
echo "=========================================================="
...
if [ "$SERVICE_UP" = true ]; then
    echo "       NO13 VERIFICATION SUCCESSFUL"
else
    echo "       NO13 VERIFICATION FAILED"
fi
echo "=========================================================="
