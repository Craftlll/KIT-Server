...
# ==============================================================================
# Script Name: run_server_test.sh (NO14 Version)
# ==============================================================================

SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"
cd "$SCRIPT_DIR"

SERVICE_SCRIPT="NO14_lite_plumber.R"
PORT=8014
GENE_TO_TEST="GAPDH"

echo "=========================================================="
echo "          Lite Service Deployment Verification (NO14)"
echo "=========================================================="
...
if [ "$SERVICE_UP" = true ]; then
    echo "       NO14 VERIFICATION SUCCESSFUL"
else
    echo "       NO14 VERIFICATION FAILED"
fi
echo "=========================================================="
