# -----------------------------------------------------------------------------
# 脚本名称: NO14_lite_plumber.R
# 功能: 低内存消耗的微服务 (NO14 定制版)
# -----------------------------------------------------------------------------
...
flog.appender(appender.file(file.path(log_dir, "lite_service_no14.log")))
flog.threshold(INFO)
...
# 启动
flog.info("Service starting (NO14)...")
...
# API
#* @get /health
function() list(status = "UP", mode = "Lite-H5-NO14")
