# -----------------------------------------------------------------------------
# 脚本名称: NO8_lite_plumber.R
# 功能: 低内存消耗的微服务 (NO8 定制版)
# -----------------------------------------------------------------------------
...
flog.appender(appender.file(file.path(log_dir, "lite_service_no8.log")))
flog.threshold(INFO)
...
# 启动
flog.info("Service starting (NO8)...")
...
# API
#* @get /health
function() list(status = "UP", mode = "Lite-H5-NO8")
