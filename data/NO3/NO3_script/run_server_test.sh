...
# ==============================================================================
# Script Name: run_server_test.sh (NO3 Version)
# ==============================================================================

SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"
cd "$SCRIPT_DIR"

SERVICE_SCRIPT="NO3_lite_plumber.R"
PORT=8003   
GENE_TO_TEST="GAPDH"

echo "=========================================================="
echo "          Lite Service Deployment Verification (NO3)"
echo "=========================================================="
...
if [ "$SERVICE_UP" = true ]; then
    echo "       NO3 VERIFICATION SUCCESSFUL"
else
    echo "       NO3 VERIFICATION FAILED"
fi
echo "=========================================================="
