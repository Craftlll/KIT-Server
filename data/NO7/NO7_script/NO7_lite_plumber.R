# -----------------------------------------------------------------------------
# 脚本名称: NO7_lite_plumber.R
# 功能: 低内存消耗的微服务 (NO7 定制版)
# -----------------------------------------------------------------------------
...
flog.appender(appender.file(file.path(log_dir, "lite_service_no7.log")))
flog.threshold(INFO)
...
# 启动
flog.info("Service starting (NO7)...")
...
# API
#* @get /health
function() list(status = "UP", mode = "Lite-H5-NO7")
