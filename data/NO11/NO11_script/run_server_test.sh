...
# ==============================================================================
# Script Name: run_server_test.sh (NO11 Version)
# ==============================================================================

SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"
cd "$SCRIPT_DIR"

SERVICE_SCRIPT="NO11_lite_plumber.R"
PORT=8011
GENE_TO_TEST="Sox17"

echo "=========================================================="
echo "          Lite Service Deployment Verification (NO11)"
echo "=========================================================="
...
if [ "$SERVICE_UP" = true ]; then
    echo "       NO11 VERIFICATION SUCCESSFUL"
else
    echo "       NO11 VERIFICATION FAILED"
fi
echo "=========================================================="
