...
# ==============================================================================
# Script Name: run_server_test.sh (NO2 Version)
# ==============================================================================
...
PORT=8002   # Port 8002 for NO2
GENE_TO_TEST="GAPDH"

echo "=========================================================="
echo "          Lite Service Deployment Verification (NO2)"
echo "=========================================================="
...
if [ "$SERVICE_UP" = true ]; then
    echo "       NO2 VERIFICATION SUCCESSFUL"
else
    echo "       NO2 VERIFICATION FAILED"
fi
echo "=========================================================="
