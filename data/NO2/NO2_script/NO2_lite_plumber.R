# -----------------------------------------------------------------------------
# 脚本名称: NO2_lite_plumber.R
# 功能: 低内存消耗的微服务 (NO2 定制版)
# -----------------------------------------------------------------------------
...
flog.appender(appender.file(file.path(log_dir, "lite_service_no2.log")))
flog.threshold(INFO)
...
# 启动
flog.info("Service starting (NO2)...")
...
# API
#* @get /health
function() list(status = "UP", mode = "Lite-H5-NO2")
